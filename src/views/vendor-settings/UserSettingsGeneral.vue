...
export default {
  data () {
    return {
      username: this.$store.state.AppActiveUser.info.username,
      name: this.$store.state.AppActiveUser.info.name,
      email: this.$store.state.AppActiveUser.info.email,
      company: this.$store.state.AppActiveUser.info.vendor.name,
      company_cc_url: 'https://video.basma.ai/' + this.$store.state.AppActiveUser.info.vendor.username
    }
  },
  computed: {
    activeUserInfo () {
